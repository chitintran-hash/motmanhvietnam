        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-16">
          <div className="col-span-1 md:col-span-2">
            <h2 className="font-display font-black text-3xl mb-6 tracking-tighter uppercase">
              MỘT MẢNH <span className="text-terracotta">VIỆT NAM</span>
            </h2>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-12 h-12 border-2 border-[#F5F2EB]/20 flex items-center justify-center hover:bg-terracotta hover:border-terracotta transition-colors">
                <FacebookIcon />
              </a>
              <a href="#" className="w-12 h-12 border-2 border-[#F5F2EB]/20 flex items-center justify-center hover:bg-terracotta hover:border-terracotta transition-colors">
                <InstagramIcon />
